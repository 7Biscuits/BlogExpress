...
const Form = ({ heading, text, text2, text3, btnText, link, fplink, userInfo }) => {
    ...
    return (
        <div className="relative flex flex-col justify-center min-h-screen max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
            <div className="px-6 py-4">
                <h3 className="mt-3 text-xl font-medium text-center text-gray-600 dark:text-gray-200">{heading}</h3>

                <p className="mt-1 text-center text-gray-200 dark:text-gray-400">{text}</p>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="flex items-center justify-between mt-4">
                        <Link to="#" className="text-sm text-gray-600 dark:text-gray-200 hover:text-gray-400">{fplink}</Link>
            ...
            <div className="flex items-center justify-center py-4 text-center bg-gray-50 dark:bg-gray-700">
                <span className="text-sm text-gray-600 dark:text-gray-200">{text2}</span>

                <Link to={link} className="mx-2 text-sm font-bold text-blue-500 dark:text-blue-400 hover:underline">{text3}</Link>
            </div>
        </div>
    )
}
