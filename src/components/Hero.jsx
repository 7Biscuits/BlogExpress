    ...
    return (
        <div className="flex flex-col items-center">
            ...
            <div className="flex flex-row gap-5 my-2">
                <Link to={"/signup"} href="/signup" className="px-4 py-2 md:px-5 md:py-3 text-sm md:text-md text-white bg-purple-600 hover:bg-purple-800 rounded-md cursor-pointer ease-in-out duration-100">Sign up</Link>
